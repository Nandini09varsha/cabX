  ...
  return (
    <RiderLayout activePage="Ride History">
      <div className="mb-7">
        ...
        <p className="mt-1 text-sm text-gray-500">Every trip stored off-chain and settled on-chain.</p>
      </div>
        ...
        <div className="space-y-3">
          {rides.map((r) => (
            <Link
              ...
              key={r._id}
              className="flex items-center justify-between rounded-2xl border border-gray-200 bg-white p-5 hover:border-[#F5C518] dark:border-[#2A2A2A] dark:bg-[#171717]"
            >
              <div className="flex items-center gap-4">
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gray-100 dark:bg-[#222]">
                  <Car size={19} />
                </div>
                <div>
                  <b>
                ...
                <div className="text-right">
                  ...
                  <p
                    className={`mt-1 flex items-center justify-end gap-1 text-xs ${
                      r.status === "completed" ? "text-green-600" : "text-gray-500"
                    }`}
                  >
