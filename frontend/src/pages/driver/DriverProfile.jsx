...
function DriverProfile() {
  ...
  return (
    <DriverLayout activePage="Profile">
      ...
      <p className="mt-1 mb-6 text-sm text-gray-500">Your driver account, stake, and vehicle hash.</p>
      <WalletBar />
...
function Info({ icon: Icon, label, value }) {
  return (
    <div className="flex items-center gap-3 rounded-xl border border-gray-200 bg-white p-4 dark:border-[#2A2A2A] dark:bg-[#171717]">
      <Icon size={18} />
      <div>
