    ...
    <DriverLayout activePage="Stake">
      ...
      {profile && (
        <div className="mb-6 grid gap-4 sm:grid-cols-3">
          <div className="rounded-2xl border border-gray-200 bg-white p-4 dark:border-[#2A2A2A] dark:bg-[#171717]">
      ...
      <form
        onSubmit={register}
        className="max-w-2xl space-y-4 rounded-3xl border border-gray-200 bg-white p-6 dark:border-[#2A2A2A] dark:bg-[#171717]"
      >
        ...
        {onchain && <p className="text-xs text-gray-500">On-chain account found for this wallet.</p>}
        <button
          disabled={busy}
          className="rounded-xl bg-[#F5C518] px-5 py-3 font-bold text-black disabled:opacity-60"
        >
